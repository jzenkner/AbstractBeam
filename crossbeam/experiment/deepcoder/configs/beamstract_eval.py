...
def get_config():
  ...
  config.data_save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/beamstract/top_and_avg_2/data"
  ...
  config.json_results_file = "/work/ldierkes/repos/new/LambdaBeam/outputs/beamstract/top_and_avg_2/eval/results_14.json"
  config.save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/beamstract/top_and_avg_2/"
