...
def get_config():
  ...
  config.data_save_dir = "" # Directory to save data 
  ...
  config.dynamic_time_increase = 30.0 # Time increasment for newfound operations
  ...
  config.json_results_file = "" # File to save results
  config.save_dir = "" # Directory to save model
