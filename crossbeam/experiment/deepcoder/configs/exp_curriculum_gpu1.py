...
def get_config():
  ...
  config.json_results_file = '/work/ldierkes/repos/ma-lukas-dierkes/ec/LambdaBeam/consolidation/output_original.json'
  config.timeout = 1000
  ...
  config.data_root = "/work/ldierkes/repos/ma-lukas-dierkes/ec/LambdaBeam"
  config.data_name = "/work/ldierkes/repos/ma-lukas-dierkes/ec/LambdaBeam/t-120-maxne-5-maxni-1-skip-0.0-lambdaskip-0.0-lambdafrac-0.8-shuffleops-False"
  config.save_dir = '/work/ldierkes/repos/ma-lukas-dierkes/ec/LambdaBeam/outputs/'
