...
def get_config():
  ...
  config.data_save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline/lambdabeam/data"
  ...
  config.json_results_file = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline/lambdabeam/results.json"
  config.save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline/lambdabeam/"
