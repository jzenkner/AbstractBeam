...
def get_config():
  ...
  config.data_save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline_4/data"
  ...
  config.json_results_file = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline_4/results.json"
  config.save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline_4/"
