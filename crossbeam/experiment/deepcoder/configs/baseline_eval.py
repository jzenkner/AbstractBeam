...
def get_config():
  ...
  config.data_save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline_3/data"
  ...
  config.json_results_file = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline_3/eval/results_22.json"
  config.save_dir = "/work/ldierkes/repos/new/LambdaBeam/outputs/baseline_3/"
